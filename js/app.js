...
(function () {
  ...
  function setArDish(dishId, opts = {}) {
    ...
    // La experiencia AR usa la primera fotografía del arreglo
    // `images` como portada (el ángulo principal del platillo).
    const coverImage = (dish.images && dish.images[0]) || dish.image;

    state.arDishId = dishId;
    els.arDishName.textContent = dish.name;
    els.arDishImg.src = coverImage;
      ...
      els.arDishImg.src =
        ...
        encodeURIComponent(
          `<svg xmlns="http://www.w3.org/2000/svg" width="320" height="240">
             ...
             <text x="50%" y="60%" fill="#f3ead9" font-family="monospace" font-size="12" text-anchor="middle">${coverImage}</text>
           </svg>`
        );
    };
